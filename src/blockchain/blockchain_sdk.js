...
function UserRegisteration(params) {
    ...
    return new Promise(function(resolve, reject){
        ...
        try{
            ...
            var reqSpec = getRequestSpec({functionName: 'User_register', args: [UserDetails.name,UserDetails.email,UserDetails.phone,UserDetails.pan,UserDetails.aadhar,UserDetails.usertype,UserDetails.upi,UserDetails.passpin]});
